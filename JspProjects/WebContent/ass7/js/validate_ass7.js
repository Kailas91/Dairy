...
// date of birth validation
   ...
   var day =document.getElementById('dateDay').value;
     if( year == "select year" )
    {
 	...
 	if (
 			document.StudentRegistration.web.checked== false &&
 			document.StudentRegistration.database.checked==false &&
 			document.StudentRegistration.swing.checked==false &&document.StudentRegistration.mobile.checked==false)
 			{
