...
*
Assignment :2
Assignment :get data from jsp and print on console and save data to databse
Author : Kailas
Date   : 16/8/2019
*/
					  ...
					  preparedstmt.setString(1, uname);
					    ...
					    if(rs.next()) {
					    	...
					    	objRequestDispatcher = request
									.getRequestDispatcher(Constants.DISPATCHERASS2);
							request.setAttribute(Constants.RESULT, Constants.ERRORFORASS3);
							...
							if (i > 0) {
								objRequestDispatcher = request
										.getRequestDispatcher(Constants.DISPATCHERASS2);
								request.setAttribute(Constants.RESULT, Constants.REGISTERED);
