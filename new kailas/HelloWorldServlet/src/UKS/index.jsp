...
function show2(){
	<%PrintWriter pw = new PrintWriter("D:\\jvs_ws\\EmployeesManager\\WebContent\\Employee.txt");
	pw.close();
	%>
...
<h1 align="center"><font color="white">Employee Registration</font></h1>
<table bgcolor="white"width="30%"height="30%"style="border:1px solid black"align="center">
<tr>
<td>Name :</td><td><input type="text" name="name"required
					placeholder="Enter first name"></td>
</tr>
<tr>
<td>Mobile No :</td><td><input type="text" name="mn"required
					placeholder="Enter Mobile No"maxlength="10"></td>
</tr>
<tr>
<td>Role :</td><td><input type="text" name="role"required
					placeholder="Enter Role"></td>
</tr>
</table>
<br><br>
<button class="button"type="submit" value="submit" >Add Details</button>
<button  class="button button3"onclick="show()">Get Details</button>
<button class="button button2"onclick="show2()">Clear Details</button>
</form>
</div>
</body>
</html>