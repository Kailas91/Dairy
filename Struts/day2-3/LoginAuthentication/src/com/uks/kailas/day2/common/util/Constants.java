 ...
 *
 */
package com.uks.kailas.day2.common.util;
...
public class Constants {
	...
	public static final String PATH="com.uks.kailas.day2.common.util.database";
	...
	public static final String QUERY_ASS_TWO_TWO="SELECT firstname,middleinitial,lastname,gender,email,dob,address FROM userdetails where userid = '";
